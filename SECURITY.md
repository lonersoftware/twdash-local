...
twdash is for localhost, vulnerabilities should not be an issue once its local, nevertheless theres the issues on github that can be used to report such, has bugs and improvements desired. 
